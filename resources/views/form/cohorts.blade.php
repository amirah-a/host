<div>
    <h2 class="font-bold text-gray-900 mb-2">This course will be delivered in 3 cohorts. Please, take note of your cohort number when selecting an option.</h2>
        ...
        <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-sm">
            ...
            <tbody class="divide-y divide-gray-200">
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-3 sm:px-6 py-4 text-sm text-gray-900">Wallerfield Activity Centre</td>
                </tr>
                <tr class="hover:bg-gray-50">
